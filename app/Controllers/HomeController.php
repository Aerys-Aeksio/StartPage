  ...
  public function update_settings()
  {
    ...
    else
    {
      ...
      [
        ...
        "default_cat_bg_color_header"   =>  $this->request->getPost('default_cat_bg_color_header'),
        "default_cat_text_color_header" =>  $this->request->getPost('default_cat_text_color_header'),
        "default_cat_bg_color_footer"   =>  $this->request->getPost('default_cat_bg_color_footer'),
        "default_cat_link_color_footer" =>  $this->request->getPost('default_cat_link_color_footer'),
        "default_cat_link_color_list"   =>  $this->request->getPost('default_cat_link_color_list'),
      ];
